...
extension Color {
	...
	static var editorDark: Color { .init(white: 0) }
	...
	static var amberLight: Color { .init(red: 0.9, green: 0.7, blue: 0.1, opacity: 0.3) }
	static var amberDark: Color { .init(red: 0.8, green: 0.6, blue: 0, opacity: 0.3) }
}
